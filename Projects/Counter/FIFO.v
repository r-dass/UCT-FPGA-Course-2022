...
/* Module Version: 5.1 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n FIFO -lang verilog -synth synplify -bus_exp 7 -bb -arch mg5a00 -type ebfifo -depth 256 -width 16 -depth 256 -no_enable -pe -1 -pf -1 -fill  */
...
module FIFO (Data, Clock, WrEn, RdEn, Reset, Q, WCNT, Empty, Full)/* synthesis NGD_DRC_MASK=1 */;
    ...
    // synopsys translate_off
    defparam pdp_ram_0_0_0.CSDECODE_B =  3'b000 ;
    defparam pdp_ram_0_0_0.CSDECODE_A =  3'b000 ;
    ...
    // synopsys translate_on
    DP16KB pdp_ram_0_0_0 (.DIA0(Data[0]), .DIA1(Data[1]), .DIA2(Data[2]), 
        ...
        .ADA9(wcount_5), .ADA10(wcount_6), .ADA11(wcount_7), .ADA12(scuba_vlo), 
        ...
        .ADB6(rcount_2), .ADB7(rcount_3), .ADB8(rcount_4), .ADB9(rcount_5), 
        .ADB10(rcount_6), .ADB11(rcount_7), .ADB12(scuba_vlo), .ADB13(scuba_vlo), 
        .CEB(rden_i), .CLKB(Clock), .WEB(scuba_vlo), .CSB0(scuba_vlo), .CSB1(scuba_vlo), 
    ...
    // synopsys translate_on
    FD1P3DX FF_28 (.D(ifcount_0), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_0))
    ...
    // synopsys translate_on
    FD1P3DX FF_27 (.D(ifcount_1), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_1))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_26 (.D(ifcount_2), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_2))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_25 (.D(ifcount_3), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_3))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_24 (.D(ifcount_4), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_4))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_23 (.D(ifcount_5), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_5))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_22 (.D(ifcount_6), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_6))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_21 (.D(ifcount_7), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_7))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_20 (.D(ifcount_8), .SP(fcnt_en), .CK(Clock), .CD(Reset), 
        .Q(fcount_8))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1S3BX FF_19 (.D(empty_d), .CK(Clock), .PD(Reset), .Q(empty_i))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_18.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1S3DX FF_18 (.D(full_d), .CK(Clock), .CD(Reset), .Q(full_i))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_17.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_17 (.D(iwcount_0), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_0))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_16.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_16 (.D(iwcount_1), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_1))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_15.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_15 (.D(iwcount_2), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_2))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_14.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_14 (.D(iwcount_3), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_3))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_13.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_13 (.D(iwcount_4), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_4))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_12.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_12 (.D(iwcount_5), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_5))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_11.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_11 (.D(iwcount_6), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_6))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_10.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_10 (.D(iwcount_7), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_7))
             /* synthesis GSR="ENABLED" */;

    // synopsys translate_off
    defparam FF_9.GSR = "ENABLED" ;
    // synopsys translate_on
    FD1P3DX FF_9 (.D(iwcount_8), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_8))
             /* synthesis GSR="ENABLED" */;
    ...
    // synopsys translate_on
    FD1P3DX FF_0 (.D(ircount_8), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_8))
             /* synthesis GSR="ENABLED" */;
    ...
    CB2 bdcnt_bctr_4 (.CI(co3), .PC0(fcount_8), .PC1(scuba_vlo), .CON(cnt_con), 
        .CO(co4), .NC0(ifcount_8), .NC1());
    ...
    ALEB2 e_cmp_4 (.A0(fcount_8), .A1(scuba_vlo), .B0(scuba_vlo), .B1(scuba_vlo), 
    ...
    AGEB2 g_cmp_4 (.A0(fcount_8), .A1(scuba_vlo), .B0(wren_i_inv), .B1(scuba_vlo), 
    ...
    CU2 w_ctr_4 (.CI(co3_3), .PC0(wcount_8), .PC1(scuba_vlo), .CO(co4_1), 
        .NC0(iwcount_8), .NC1());
    ...
    CU2 r_ctr_4 (.CI(co3_4), .PC0(rcount_8), .PC1(scuba_vlo), .CO(co4_2), 
        .NC0(ircount_8), .NC1());
    ...
    // exemplar attribute pdp_ram_0_0_0 CSDECODE_B 0b000
    // exemplar attribute pdp_ram_0_0_0 CSDECODE_A 0b000
    // exemplar attribute pdp_ram_0_0_0 WRITEMODE_B NORMAL
    // exemplar attribute pdp_ram_0_0_0 WRITEMODE_A NORMAL
    // exemplar attribute pdp_ram_0_0_0 GSR DISABLED
    // exemplar attribute pdp_ram_0_0_0 RESETMODE ASYNC
    // exemplar attribute pdp_ram_0_0_0 REGMODE_B NOREG
    // exemplar attribute pdp_ram_0_0_0 REGMODE_A NOREG
    // exemplar attribute pdp_ram_0_0_0 DATA_WIDTH_B 18
    // exemplar attribute pdp_ram_0_0_0 DATA_WIDTH_A 18
