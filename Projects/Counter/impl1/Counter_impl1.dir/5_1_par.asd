...
GLOBAL_PRIMARY_0_LOADNUM = 123;
; Global primary clock #1
GLOBAL_PRIMARY_1_SIGNALNAME = ipClk_c;
GLOBAL_PRIMARY_1_DRIVERTYPE = CLK_PIN;
GLOBAL_PRIMARY_1_LOADNUM = 105;
; # of global secondary clocks
GLOBAL_SECONDARY_USED = 3;
; Global secondary clock #0
GLOBAL_SECONDARY_0_SIGNALNAME = UART_Packets_reveal_coretop_instance/counter_la0_inst_0/reset_rvl_n;
...
GLOBAL_SECONDARY_1_LOADNUM = 123;
